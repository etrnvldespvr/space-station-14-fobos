...
ent-CBURNTechFab = ЗажигФаб РХБЗЗ
    .desc = Отличается от обычного ТехФаба патронов ассортиментом из зажигательных патрон на любой вкус. Необходим для ликвидационных мероприятий РХБЗЗ.
